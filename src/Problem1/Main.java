...
public class Main {
    public static void main(String[] args) {
        ...
        Customer customer1 = new Customer("Hiago", "Dias", "332-221-4444");
        customer1.setBillingAddress(address1);
        customer1.setShippingAddress(address2);

        Customer customer2 = new Customer("Julie", "Johnson", "223-113-5555");
        customer2.setBillingAddress(address3);
        customer2.setShippingAddress(address4);

        Customer customer3 = new Customer("Will", "Smith", "445-667-8899");
